...
@version: 1.0.1
useage:
python D:\ssdftp\stability\copydir_continue.py D:\ssdftp\stability\mu D:\ssdftp\iis\ftp1 D:\ssdftp\stability\logs\task1.log 3000 5 mu_
每隔3000秒拷贝D:\ssdftp\stability\mu目录5次到D:\ssdftp\iis\ftp1目录下，文件夹命名为mu_1..mu_5,记录日志
到d:\ssdftp\stability\task1.log_当前日期.log,等待3000秒后继续下轮拷贝.

1.0.1 初始脚本，支持定时拷贝目录，循环时间到立即进行下轮拷贝
...
if __name__ == '__main__':
    ...
    if (len(sys.argv) == 7):
        dirprefix = sys.argv[6]
    else:
        dirprefix = "fgapdir_"    #生成文件时的文件名前缀
