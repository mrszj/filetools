...
@version: 1.0.1
useage:
python D:\ssdftp\stability\delfile_ncftpget.py D:\ssdftp\iis\ftp1 1024 ".SUTMP:.sutmp:.000001" "d:\ssdftp\stability\dest\logs\task1.log" 1800 fgapfile_ test test 192.168.2.110 /initrd/data/haoxin/ /
每隔1800秒删除D:\ssdftp\iis\ftp1目录下,大小为1024字节,以fgapfile_开头的文件,忽略后缀名为.SUTMP .sutmp .000001的文件,记录日志，通过ncftpget，下载文件用户test ，密码test，把192.167.2.110ftp服务器目录下的所有文件传输到/initrd/data/haoxin/目录下
...
if __name__ == '__main__':
    ...
    ftpuser = sys.argv[7]          #FTP用户
    ftppasswd = sys.argv[8]        #FTP密码
    ftpip = sys.argv[9]      #FTP地址
    localpath = sys.argv[10]    #本地目录
    ftpgetpath = sys.argv[11]   #FTP下载目录
